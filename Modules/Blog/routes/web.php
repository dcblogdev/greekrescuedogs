...
Route::prefix(config('admintw.prefix'))->middleware(['web', 'auth', 'activeUser', 'IpCheckMiddleware'])->group(function () {
...
Route::prefix('blog')->group(function () {
    ...
    Route::get('feed', [XmlController::class, 'rss'])->name('blog.feed');
    Route::get('rss', [XmlController::class, 'rss'])->name('blog.rss');
    Route::get('posts.xml', [XmlController::class, 'xml'])->name('blog.xml');
